...
def test_profiled_csv_prompt_includes_cell_location_metadata(quote_dictionary) -> None:
    ...
    assert "Never cite an atomic source" in boundaries["price_basis_vs_order_increment"]
    assert "numeric amount source alone is insufficient" in boundaries["shipping_vs_other_fees"]
