...
def _run_supplier(
    ...
    try:
        ...
        record = {
            ...
            "scoring_note": "No A-approved reference was used; PASSED covers structural checks only.",
        ...
        record = {
            ...
            "correction_state": "PRE_CORRECTION",
            "scoring_status": "UNSCORED",
            "scoring_note": "No A-approved reference was used; this failed run has no field-accuracy score.",
            "status": "FAILED",
