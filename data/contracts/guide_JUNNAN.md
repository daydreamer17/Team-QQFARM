...
2. 整理 `quote_V1` 至 `quote_V5` 开发数据，覆盖基准输入、现实字段差异、31 字段直接表达、极端边界及多样化泛化测试。
3. 建立版本化参考答案；V2、V3、V4、V5 已提交，运行时不得读取。
...
1. 选择测试版本：V1 基准、V2 现实缺失、V3 字段表达、V4 异常和安全边界、V5 多样化泛化。
